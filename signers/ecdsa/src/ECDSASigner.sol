...
import {ISigner, IStatelessValidator, IStatelessValidatorWithSender} from "./interfaces/IERC7579Modules.sol";
...
contract ECDSASigner is ISigner, IStatelessValidator, IStatelessValidatorWithSender {
    ...
    function isModuleType(uint256 typeID) external pure override returns (bool) {
        return typeID == MODULE_TYPE_SIGNER || typeID == MODULE_TYPE_STATELESS_VALIDATOR || typeID == MODULE_TYPE_STATELESS_VALIDATOR_WITH_SENDER;
    }
