...
import {IValidator, IHook, IStatelessValidator, IStatelessValidatorWithSender} from "./interfaces/IERC7579Modules.sol";
import {
...
contract ECDSAValidator is IValidator, IHook, IStatelessValidator, IStatelessValidatorWithSender {
    ...
    function isModuleType(uint256 typeID) external pure override returns (bool) {
        return typeID == MODULE_TYPE_VALIDATOR || typeID == MODULE_TYPE_HOOK || typeID == MODULE_TYPE_STATELESS_VALIDATOR || typeID == MODULE_TYPE_STATELESS_VALIDATOR_WITH_SENDER;
    }
        ...
        returns (uint256)
    {
        ...
        return _verifySignature(userOpHash, userOp.signature, owner) ? SIG_VALIDATION_SUCCESS_UINT : SIG_VALIDATION_FAILED_UINT;
    }
